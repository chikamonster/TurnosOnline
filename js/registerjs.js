document.getElementById("btn__registrarse").addEventListener("mouseup", register);
document.getElementById("btn__iniciar-sesion").addEventListener("mouseup", iniciarSesion);
